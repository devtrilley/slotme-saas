  ...
  return (
    <div className="max-w-md mx-auto p-6 space-y-8 text-center">
      ...
      <div className="space-y-2">
        <h1 className="text-3xl font-extrabold">SlotMe</h1>
        <p className="text-gray-400 text-sm">
          Modern appointment booking for freelancers, coaches, barbers,
          trainers, and more.
        </p>
        <p className="text-xs text-gray-500 italic">
          No sign-up needed for users. Share your link. Get booked. Get paid.
          Simple.
        </p>
      </div>
      ...
      <div className="bg-base-200 border rounded-lg p-4 shadow space-y-2">
        ...
        <a href="/book/1" className="btn btn-outline btn-primary w-full">
          Try Demo Booking Page
        </a>
      </div>

      {/* Client and Dev Login CTA */}
      <div className="grid grid-cols-1 gap-3">
        <Link to="/client-login" className="btn btn-primary w-full">
          Client Login
        </Link>
      ...
      <div className="space-y-4 pt-4 text-left">
        ...
        <ul className="list-disc list-inside text-sm text-gray-400 space-y-2">
          <li>✔️ Instant booking with no user account required</li>
          <li>✔️ Mobile-optimized for fast scheduling on the go</li>
          <li>✔️ Each client gets a branded booking page</li>
