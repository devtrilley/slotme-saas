...
export default function Upgrade() {
  ...
  const tiers = [
    ...
    },
    {
      ...
      features: [
        ...
        { label: "Service Add-Ons", value: true },
        { label: "Custom Booking Questions", value: true },
        { label: "Priority Support", value: true },
        { label: "SMS Reminders", value: true },
      ],
    },
  ];
  useEffect(() => {
    ...
    if (hash.toLowerCase().startsWith("#pro")) {
      ...
      if (el) {
        ...
        el.classList.add("ring", "ring-purple-400", "ring-offset-2");
        setTimeout(() => {
          el.classList.remove("ring", "ring-purple-400", "ring-offset-2");
        }, 2000);
      }
    }
  }, []);
  ...
  const getTierButton = (tierKey) => {
    if (!isLoggedIn) {
      return {
        text: tierKey === "free" ? "Try for Free" : "Start Free Trial",
      ...
      <div className="bg-gradient-to-r from-[#7C3AED] to-[#6366F1] text-white py-8 px-6 rounded-2xl shadow-lg shadow-purple-500/50 text-center space-y-4">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm font-semibold text-purple-100">
            A barber doing $5k/mo pays $130 to Square. SlotMe is $20 flat.
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col md:hidden gap-6">
        {tiers.map((tier) => {
          ...
          return (
            <div
              key={tier.name}
              id={tier.key === "pro" ? "pro-tier" : undefined}
